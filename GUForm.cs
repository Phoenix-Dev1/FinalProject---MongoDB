...
namespace FinalProject
{
    public partial class GUForm : Form
    {
        ...
        {
            string guestId = textBox_GU_Guest_Id.Text;
            ...
            try
            {
                ...
                FilterDefinition<Guests> filter = Builders<Guests>.Filter.Eq(guest => guest.GuestId, guestId);
                ...
                {
                    MessageBox.Show("Guest Id :" + guestId + " Successfuly deleted!\n\nPress OK to close this window",
                        "Guest Deleted", MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
                else
                {
                    MessageBox.Show("Guest Id :" + guestId + " Failed to be deleted\n\nPress OK to close this window",
                       "Guest Not Deleted", MessageBoxButtons.OK, MessageBoxIcon.Error);
                }
            }
            catch (Exception ex)
            {
                MessageBox.Show("Guest Number :" + guestId + " Failed to be deleted, we got the following exception: \n\n" + ex.Message + "\n\nPress OK to close this window",
                       "Guest Not Deleted", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
            this.Close();
        }
        ...
        private void btn_GU_Update_Click(object sender, EventArgs e)
        {
            ...
            UpdateDefinition<Guests> updateDefinition = Builders<Guests>.Update
                .Set(guest => guest.GuestId, guestId)
            ...
            try
            {
                ...
                {
                    MessageBox.Show("Guest Id:" + guestId + " Successfuly updated!\n\nPress OK to close this window",
                    "Guest Updated", MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
                else
                {
                    MessageBox.Show("Guest Id" + guestId + " Failed to be updated\n\nPress OK to close this window",
